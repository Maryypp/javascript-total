function multiplicar(){
    //Obtener numero
    let elementoTextoTabla = document.
    getElementById("textoTabla");
    let textoNumeroTabla = elementoTextoTabla.ariaValueMax;
    let numeroTabla = Number(textoNumeroTabla);

    //Obtener la tabla
    let elementoTablaMultiplicar = document.
    getElementById("listaTabla");
    ...
    for(x=1; x<=10; x++){
        ...
        let textoResultado = numeroTabla + " por " +
        x + " es igual a " + numeroResultado
